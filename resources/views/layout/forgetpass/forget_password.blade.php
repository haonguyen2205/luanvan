	   ...
	   <!--header-->
        ...
        <div class="main-content-agile">
            <div class="sub-main-w3">
                ...
                <form action="{{URL::to('/mail-foget-password')}}" method="post">
                {{ csrf_field() }}
                    <div class="pom-agile">
                        <input  class="user" type="hidden" name="id" value="" required="">
                    </div>
                    <div class="pom-agile">
                        <input  placeholder="email đăng nhập" name="email" class="form-control my-2" minlength="6" maxlength="70" type="email" required>
                    </div>
